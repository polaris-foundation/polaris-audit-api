...
from dhos_audit_api.models.api_spec import dhos_audit_api_spec
...
def test_openapi(tmp_path: str, app: Flask) -> None:
    ...
    generate_openapi_spec(
        dhos_audit_api_spec, new_spec_path, api_blueprint, api_v1_blueprint
    )

    new_spec = yaml.safe_load(new_spec_path.read_bytes())
    existing_spec = Path(__file__).parent / "../dhos_audit_api/openapi/openapi.yaml"
